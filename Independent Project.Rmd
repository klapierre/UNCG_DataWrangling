...
ggplot(mite, aes(x=Site, y=Total)) +
  geom_col(fill = "cyan4") +
...
mapview(mite, xcol = "Long", ycol = "Lat", crs = 4269, grid = FALSE)
```



```{R Interactive Map of Site Locations With point size based on total cigger mites}
miteSpatial <- st_as_sf(mite, coords = c("Long", "Lat"), crs = 4269)
mapview(miteSpatial, 
        zcol = "Site",
        cex = "Total", 
        legend = TRUE, 
