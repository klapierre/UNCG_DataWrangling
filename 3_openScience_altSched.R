...
duplicates <- rbind(headconSME_abundace, conSMEcoverAlt)
...
## The number of rows increases (adds together), while the number of columns 
## stays the same. 
...
## They have the same information listed twice 
...
## noDuplicates shows the unique set of observations across the two datasets,
## while duplicates includes every row from both.
...
## I would most definitely recommend this class!
