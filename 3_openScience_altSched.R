...
## There is a duplication of each value as each data table had both values.
...
## They both contain the same data for each category.
...
## There are less obs. than either of the originals (9175 vs. 9245)
...
## It's still ahead by one commit.
