...
#It seems like these two are actually sorted correctly because they have the same data
...
#All of the dataframes have the same number of observations as before except for the noDuplicates it has less observations.
...
#The comment showed up in a text box but i am still ahead by one commit.
