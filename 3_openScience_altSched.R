...
duplicates <- rbind(conSMEcoverAlt, conSMEcoverAlt)
...
## The duplicates matrix has double the observations of the original.
...
## It has less less observations when compared to the duplicates variable
## and the original.
