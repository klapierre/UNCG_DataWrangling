...
## The number of observations in the data frame "duplicates" is twice the number of observations in each of the other "conSME" data frames. This means that the "duplicates" data frame correctly bound the number observations of both "conSME" data frames into one large data frame. 
