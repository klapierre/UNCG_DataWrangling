...
lubridate::today() #This shows us the current date
Sys.time() # This shows the time as designated by the computer system
lubridate::now() # This shows the current time, date, and timezone
lubridate::now(tzone = "UTC") # This shows the above information in the UTC information
lubridate::leap_year(today()) # This tells us when a leap year will be
