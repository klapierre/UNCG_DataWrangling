...
## First, it's time to load in the csv files. For this project, I will just be working with one of the parks, Peabody Park. Plus the land_cover data that will be used across all of the parks.
```{r,read.csv}
