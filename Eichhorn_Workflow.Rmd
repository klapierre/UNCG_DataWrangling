...
pbp_join <- left_join(clean_pbp,filter_cover, by="box", copy=FALSE)
```

```{r}

price_join <- left_join(clean_pbp,filter_cover, by="box", copy=FALSE)
```

```{r}
gnc_join <- left_join(clean_gnc,filter_cover, by="box", copy=FALSE)
```

```{r}
cntry_join <- left_join(clean_cntry,filter_cover, by="box", copy=FALSE)
```
