...
x=class ggplot uses the values of the varibale as the catogery lables on the x-axis 
...
the coord_cartesian() is what controls the visble viewing window of the grpah. it display shwoing on the y-axis 0 to 50 
