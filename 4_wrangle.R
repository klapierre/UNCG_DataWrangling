...
# commits related to this assignment. Open the Rproject for our course
# (UNCG_DataWrangling), pull any changes from GitHub, and navigate to the
# branch you created RStudio's Git tab. Open this week's
# assignment in your branch to complete and submit on GitHub.
...
# TASK: Install tidyverse and load the library. HINT: see the end of assignment 
# #1 if you forget how to install and load a package.
