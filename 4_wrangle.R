...
#R seems to now have attached data to certain factors. In this case it looks like dates? When
#strings as factors is set to false, this doesn't happen.
...
#str() seems to help explain data structure. 5 columns and 61100 rows.
