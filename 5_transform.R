...
## Each variable forms a column, each observations forms a row, and each cell is a single measurement.
...
## 'skip = 10' is going to tell the code to not read the first 10 observations.
