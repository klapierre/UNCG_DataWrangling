...
#The width column changes from 1000 to 50
...
#We have the argument !=0 because it blocks out all the values equal to 0 and if we change it to !=1 it means that it will get rid of the values that are not equal to 1.
...
#While and repeat loops differ in that they are opposites. While loops depend on continuously looping TRUE until it becomes FALSE. And repeat loops continuously running FALSE until it becomes TRUE.
...
#The scatterplot does in fact have a legend now!
