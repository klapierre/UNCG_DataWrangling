...
#library(metR)
#pal <- brewer_pal(type = "div", palette = "Hokusai1")(3) #create a vector composed of 3 colors from Hokusai1 palette

my_pal <- c("#b75347","#224b5e","#94b594")
ggplot(PBG_combined,aes(x=treatment,y=as.numeric(concentration),color=treatment))+
  geom_boxplot()+
  facet_wrap(~test,scales="free_y")+
  labs(x="Treatment",y="Concentration(mg N/L)")
