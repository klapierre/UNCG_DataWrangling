...
#x axis is the same but the scale changed I believe. the y axis now has a label of 'count'
...
#the bars became thicker. Each bar now has a width of 50 instead of 30?
...
#as.factors statement allowed each value of ScaleAge to be its own color rather than without,
#the colors of different ScaleAge blend together and harder to differentiate.
