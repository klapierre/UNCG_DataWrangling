...
## it adds 50 to the values in the width columns.
...
if (x%%2 != 1) 
  next 
print(x)}
## it printed all of the odd numbers up to 20 (obviously not including 20 since that's even)
