...
if (x%%2 != 1) # A further condition is set in which x is divided by 2 if not equal to 0
...
# from odd numbers to even numbers
...
# Repeat loops will keep repeating until they no longer can
# While loops will repeat only if they are allowed to
