...
#Top plants figure. Shows which plant species are most prevelent in the study.
```{r, message=FALSE}
...
#Top Pollinators Figure. Shows which pollinators are the most prevelent in the #study.
```{r, message=FALSE}
...
#Heatmap figure. This figure shows all of the plants and pollinators and which #pollinators pollinate primarily what species.
```{r, message=FALSE}
...
#Visits by meadow Figure. Given more information about what is in each meadow #this figure can be used to show what species grow and live in what sorts of #environments.
```{r, message=FALSE}
...
#Temperature influence on visitation Figure. Showing how when temperatures are 
#Too low or too high there is an influence on the number of pollinators.
```{r, message=FALSE}
