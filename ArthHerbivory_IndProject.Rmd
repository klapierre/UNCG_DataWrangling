...
## Pseudo-Code
1. Load data and tidyverse package
2. Tidy data and combine 'Chew' and 'Mine.Suck' Herbtypes
3. Separate data between different species and years
4. Use ggplot to graph Arthropod herbivore damage through time by species
