...
Now things are going to get a little dicey. I need to join the data sets of the sample and Sample columns. 
But, before I can get there, I need to modify our two columns and create 
...
```{r, warning=FALSE}
PBG_Join <- PBG_Filter%>% 
separate(col = Sample, into = c('watershed', 'treatment', 'plot', 'element'), sep = '-')
