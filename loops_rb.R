...
#we would add 50 to everything instead
...
if (x%%2 != 1) 
  next 
print(x)}
# it starts at 19 rather than 18
...
#A while loop keeps repeating a block of code until a certain
# logical parameter is met.The repeat loop needs a break programmed in to prevent it from running forever. 
...
data(iris)
plot(y=iris$Sepal.Width, x=iris$Sepal.Length, xlab="Length", ylab="Width", main="Plant Data")
